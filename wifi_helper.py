...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python wifi_helper.py <nom_du_reseau> [mot_de_passe]")
        print("Exemple réseau protégé: python wifi_helper.py MonReseau MonMotDePasse")
        print("Exemple réseau ouvert: python wifi_helper.py ReseauPublic")
        sys.exit(1)
