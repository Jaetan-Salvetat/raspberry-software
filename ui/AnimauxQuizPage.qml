...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - AnimauxQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions sur les animaux")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("animaux", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("animaux", selectedAge)
            ...
            if (!result && typeof csvQuizLoader !== "undefined" && csvQuizLoader !== null) {
                ...
                result = csvQuizLoader.loadQuestions("animaux.csv", selectedAge)
            ...
            if (result) {
                ...
                questions = [
                    ...
                    },
                    {
                        ...
                        answers: ["Vache", "Chien", "Chat", "Cochon"],
                        correct: "Vache"
                    },
                    {
                        question: "Quel animal a une trompe ?",
                        answers: ["Éléphant", "Girafe", "Lion", "Singe"],
                        correct: "Éléphant"
                    }
                ]
                showQuestion()
