...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - FormesQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions de formes")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("formes", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("formes", selectedAge)
            ...
            if (!result && typeof csvQuizLoader !== "undefined" && csvQuizLoader !== null) {
                ...
                result = csvQuizLoader.loadQuestions("formes.csv", selectedAge)
            ...
            if (result) {
                ...
                questions = [
                    ...
                    {
                        question: "Quelle est la forme d'une fenêtre ?",
                        answers: ["Rectangle", "Cercle", "Triangle", "Étoile"],
                        correct: "Rectangle"
                    },
                    {
                        question: "Quelle est la forme d'un chapeau pointu ?",
                        answers: ["Triangle", "Carré", "Cercle", "Rectangle"],
                        correct: "Triangle"
                    }
                ]
                showQuestion()
