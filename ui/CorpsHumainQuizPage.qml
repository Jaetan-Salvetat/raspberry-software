...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - CorpsHumainQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions sur le corps humain")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("corps humain", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("corps humain", selectedAge)
            ...
            if (!result && typeof csvQuizLoader !== "undefined" && csvQuizLoader !== null) {
                ...
                result = csvQuizLoader.loadQuestions("corps humain.csv", selectedAge)
            ...
            if (result) {
                ...
                questions = [
                    ...
                    },
                    {
                        ...
                        answers: ["La bouche", "Les yeux", "Les oreilles", "Le nez"],
                        correct: "La bouche"
                    }
                ]
                showQuestion()
