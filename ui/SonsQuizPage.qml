...
Page {
    ...
    Component.onCompleted: {
        console.log("DEBUG - SonsQuizPage.qml - Component.onCompleted")
        loadQuestions()
    }
    
    // Charger les questions depuis le CSV
    function loadQuestions() {
        console.log("DEBUG - Début du chargement des questions sur les sons")
        ...
        try {
            ...
            try {
                ...
                if (typeof subjectLoader !== "undefined" && subjectLoader !== null) {
                    ...
                    result = subjectLoader.loadQuestions("sons", selectedAge)
            ...
            if (!result && typeof quizController !== "undefined" && quizController !== null) {
                ...
                result = quizController.loadQuestions("sons", selectedAge)
            ...
            if (!result && typeof csvQuizLoader !== "undefined" && csvQuizLoader !== null) {
                ...
                result = csvQuizLoader.loadQuestions("sons.csv", selectedAge)
                ...
                questions = [
                    {
                        ...
                        answers: ["Le coq", "Le chien", "Le chat", "La vache"],
                        correct: "Le coq"
                    },
                    {
                        question: "Quel animal fait 'cui-cui' ?",
                        answers: ["L'oiseau", "Le chien", "Le chat", "La vache"],
                        correct: "L'oiseau"
                    },
                    {
                        question: "Quel objet fait 'ding-dong' ?",
                        answers: ["La sonnette", "Le téléphone", "La voiture", "Le train"],
                        correct: "La sonnette"
                    }
                ]
                showQuestion()
